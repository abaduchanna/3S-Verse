  ...
  return (
    <div className="min-h-screen bg-[#060509] text-white">
      ...
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-14">
        <div className="font-mono-tech text-[10px] uppercase tracking-[.3em] text-[#6ee7ef]">
        ...
        <p className="mt-5 text-[15px] font-light leading-7 text-[#b9b6c9]">
        ...
        {failed && (
          <div className="mt-8 rounded-2xl border border-amber-400/30 bg-amber-400/[.06] p-5 text-[13.5px] leading-6 text-[#e8e6f2]">
            Could not load the live file list. Get the installers directly from the{' '}
            <a className="text-[#6ee7ef] hover:underline" href={RELEASES_PAGE} target="_blank" rel="noopener noreferrer">
              releases page
            </a>.
          </div>
        )}
        ...
        {assets === null && !failed && (
          <div className="mt-10 flex items-center gap-3 text-[13px] text-[#8d8a9e]">
        ...
        {assets !== null && (
          <div className="mt-10 space-y-4" data-testid="download-list">
            {assets.map((asset) => {
              ...
              return (
                <div
                  ...
                  className="rounded-2xl border border-white/[.07] bg-[#0b0a11] p-6"
                >
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="min-w-0">
                      ...
                      <div className="mt-1 font-mono-tech text-[10px] uppercase tracking-[.16em] text-[#8d8a9e]">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 rounded-xl bg-white px-5 py-3 text-[13.5px] font-semibold text-[#0b0a10] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#f7f3e8]"
                    >
                  ...
                  {sha ? (
                    <div className="mt-4 border-t border-white/[.06] pt-3">
                      <div className="font-mono-tech text-[9px] uppercase tracking-[.18em] text-[#8d8a9e]">
                        SHA-256 — verify before running
                      </div>
                      <code
                        data-testid={`sha-${asset.name}`}
                        className="mt-1 block break-all font-mono-tech text-[11px] leading-5 text-[#c9c6d8]"
                      >
                        {sha}
                      </code>
                    </div>
            ...
            <div className="rounded-2xl border border-white/[.07] bg-[#0b0a11] p-6">
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="min-w-0">
                  <div className="text-[15.5px] font-medium text-white">All three tools — the Full Bundle</div>
                  <div className="mt-1 font-mono-tech text-[10px] uppercase tracking-[.16em] text-[#8d8a9e]">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-xl border border-white/15 px-5 py-3 text-[13.5px] font-semibold text-[#d8d5e8] transition-colors hover:border-white/40 hover:text-white"
                >
        ...
        <div className="mt-10 rounded-2xl border border-[#6ee7ef]/20 bg-[#6ee7ef]/[.04] p-6" data-testid="download-security">
          <div className="flex items-center gap-2.5">
            <ShieldCheck className="h-4 w-4 text-[#6ee7ef]" />
            <h2 className="text-[15px] font-medium text-white">Before you run the installer</h2>
          </div>
          <ul className="mt-3 space-y-2.5 text-[13.5px] font-light leading-6 text-[#b9b6c9]">
            {[
              ...
              <li key={line} className="flex gap-2.5">
                <Check className="mt-1 h-3.5 w-3.5 shrink-0 text-[#6ee7ef]" /> {line}
              </li>
            ))}
          </ul>
          <p className="mt-4 text-[12.5px] leading-5 text-[#8d8a9e]">
            More detail:{' '}
            <a href="#/security" className="text-[#6ee7ef] hover:underline">Security</a> ·{' '}
            <a href="#/eula" className="text-[#6ee7ef] hover:underline">License terms</a> ·{' '}
            <a href="#/privacy" className="text-[#6ee7ef] hover:underline">Privacy</a>
